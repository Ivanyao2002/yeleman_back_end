...
import property.models.image_model
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_type', models.CharField(choices=[('Appartement', 'Appartement'), ('Villa', 'Villa'), ('Studio', 'Studio'), ('Duplex', 'Duplex')], default='Villa', max_length=30, verbose_name='Type de propriété ')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name="Date d'édition ")),
                ('status', models.BooleanField(default=True, verbose_name='Status ')),
                ('image', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, validators=[property.models.image_model.file_validation], verbose_name='image')),
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='property.propertymodel')),
            ],
            options={
                'verbose_name': 'Image',
